...
- Root-level JavaScript files are legacy/internal copies from earlier test harnesses. Do not import them in new code; they are not part of the supported API and may be removed.
