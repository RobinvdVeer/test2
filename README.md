...
- Root-level JavaScript files are compatibility entry points that delegate to the canonical modules in `public/`.
- Documentation examples should use `public/` paths for browser code and reusable helpers.
