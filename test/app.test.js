...
test('Helm service is externally reachable via configurable NodePort', { skip: !commandExists('helm') }, () => {
  ...
  assert.equal(renderedServiceNodePort(renderedDefault), 32080);
  assert.ok(renderedServiceNodePort(renderedDefault) >= 30000 && renderedServiceNodePort(renderedDefault) <= 32767);
